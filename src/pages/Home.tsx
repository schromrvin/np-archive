            ...
            <div className="w-full grid gap-4">
                <Link to="/scavenger-hunt">
                    <GlassPane className="group flex items-center gap-4 hover:scale-[1.02] active:scale-[0.98] cursor-pointer border-np-gold/30 hover:border-np-gold transition-all">
                        ...
                        <div className="flex-1 text-left">
                            <h3 className="font-bold text-slate-800 text-lg">Scavenger Hunt</h3>
                            <p className="text-sm text-gray-500">Explore campus, solve clues.</p>
                        </div>
                    </GlassPane>
                </Link>
                ...
                <Link to="/heritage">
                    <GlassPane className="group flex items-center gap-4 hover:scale-[1.02] active:scale-[0.98] cursor-pointer transition-all">
                        ...
                        <div className="flex-1 text-left">
                            <h3 className="font-bold text-slate-800 text-lg">Heritage Map</h3>
                            <p className="text-sm text-gray-500">Interactive campus history.</p>
                        </div>
                    </GlassPane>
                </Link>
                ...
                <Link to="/memory">
                    <GlassPane className="group flex items-center gap-4 hover:scale-[1.02] active:scale-[0.98] cursor-pointer transition-all">
                        ...
                        <div className="flex-1 text-left">
                            ...
                            <p className="text-sm text-gray-500">Share & discover stories.</p>
                        </div>
                    </GlassPane>
                </Link>
            </div>
