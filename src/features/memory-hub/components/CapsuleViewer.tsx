            ...
            {capsule && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="bg-white rounded-3xl w-full max-w-2xl overflow-hidden relative z-10 shadow-2xl max-h-[75vh] flex flex-col"
                    >
                        <div className="overflow-y-auto flex-1 scrollbar-thin scrollbar-thumb-gray-200">
                            <div className="relative h-64 md:h-80 flex-shrink-0">
                                ...
                                <button
                                    onClick={onClose}
                                    className="absolute top-4 right-4 z-20 bg-black/30 hover:bg-black/50 text-white p-2 rounded-full transition-colors backdrop-blur-sm"
                                >
                                    <X className="w-5 h-5" />
                                </button>
                            ...
                            <div className="p-8 md:p-10 bg-white min-h-[200px]">
                                ...
                                {capsule.mediaUrl && (
                                    <div className="mt-6">
                                        <h4 className="text-sm font-bold text-gray-400 uppercase tracking-wider mb-2">Attached Media</h4>
