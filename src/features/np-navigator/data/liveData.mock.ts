...
export const liveDataMock: LiveData = {
  ...
  facilities: [
    { name: "GymWerkz", status: "Open", closes: "9:00 PM", crowdLevel: "Low", location: "Sports Complex, Block 16, Level 2", images:[]},
    { name: "Maker's Academy", status: "Open", closes: "6:00 PM", crowdLevel: "Medium", location: "Block 56, Level 1", images:[] },
    { name: "The Ngee Ann Shop", status: "Closed", closes: "5:00 PM", crowdLevel: "Medium", location: "Block 58, Level 1", images:[] },
    { name: "Gen AI Hub", status: "Open", closes: "6:00 PM", crowdLevel: "Low", location: "School of ICT", images:[] },
  ],
};
